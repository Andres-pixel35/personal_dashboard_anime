# null values being fillin
## movie
**Episodes**, there was one missing value in episodes, since is a movie it was filled with a 1
...
## ona
**Episodes**, there were 30 entries missing values in episodes, the median was calculated and used to filled those rows

**Duration**, there were 5 entries missing values in duration, the median was calculated and used to filled those rows
...
**Duration**, there were 12 entries missing values in duration, the median was calculated and used to filled those rows
...
**Duration**, there were 3 entries missing values in duration, the median was calculated and used to filled those rows
